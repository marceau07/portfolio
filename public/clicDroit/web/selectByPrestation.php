...
$carte = new Carte($db);
if ($_POST['idPrestation'] != 0) {
    $newRow = $carte->selectByPrestation($_POST['idPrestation']);
    $hours = $carte->selectByMonthPrestation($_POST['idPrestation']);
    foreach ($newRow as $n) {
    ...
    foreach ($newRow as $n) {
        echo '<tr style="font-style:normal">';
        echo '<td></td>';
        echo '<td><b>' . $n['nameChantier'] . '&nbsp;(' . $n['codeChantier'] . ')</b></td>';
        echo '<td><b>' . $n['namePrestation'] . '</b></td>';
        echo '<td><b>' . $n['dateJanvier'] . '</b></td>';
        ...
        echo '<td><b>' . $n['dateDecembre'] . '</b></td>';
        echo '<td><b>' . round($n['total'], 2) . '</b></td>';
        echo '<td><a href="#"  class="btn btn-xs btn-danger"><i data-id="' . $n['idCarte'] . '" class="fa fa-trash btnDelete"></i></a></td></tr>';
    }
    echo '<tr>
                <td></td>
                <td><b>TOTAL Heures</b></td>
