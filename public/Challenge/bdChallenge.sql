...
-- Généré le :  Jeu 19 Septembre 2019 à 08:18
...
INSERT INTO `ACTIVITE` (`codeAct`, `nomAct`, `descAct`, `idMateriel`) VALUES
(22, 'oui', 'oi', 2);
...
INSERT INTO `CLIENT` (`idCli`, `email`, `mdp`, `nom`, `prenom`, `dateNaiss`, `cp`, `ville`, `rue`, `tel`, `idRole`, `idRdv`) VALUES
(5, 'aa@aa.fr', '$2y$10$gJuMIQlglT97K68RbYV7G.0gS0JCHtgOY5dy.OlBDfvTFvrb5Isme', 'aa', 'aa', '2000-07-07', '62450', 'aa', 'aa', '0321504878', 1, 3),
(6, 'marceau0707@gmail.com', '$2y$10$ZME2I2W5tqXH9IC0gmRJTeAcfNpN5ZcE3o6fiWgEimr2cAw/v6mXm', 'RODRIGUES', 'Marceau', '1999-07-07', '62400', 'Bethune', 'Verquin', '0638265641', 2, 1),
(7, 'romain.kata@laposte.net', '$2y$10$4Ovo9h7A/f1itO0BW/nESOzroibIsxpf7QpN.e/BqmgmezL.mmv7O', 'Kata', 'Romain', '2000-07-07', '62450', 'Warlencourt-Eaucourt', 'Eglise', '0321504878', 1, NULL);
...
INSERT INTO `RDV` (`idRdv`, `selection`) VALUES
(1, '2019-09-10 06:26:20'),
(2, '2019-09-21 18:00:00'),
(3, '2019-10-23 02:13:00');
...
ALTER TABLE `RDV`
  ...
  ADD UNIQUE KEY `selection` (`selection`);
...
--
ALTER TABLE `ACTIVITE`
  MODIFY `codeAct` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `MATERIEL`
  MODIFY `codeMateriel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `PRESTATION`
--
ALTER TABLE `PRESTATION`
  MODIFY `idPrest` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `ACTIVITE`
  ADD CONSTRAINT `ACTIVITE_ibfk_1` FOREIGN KEY (`idMateriel`) REFERENCES `MATERIEL` (`codeMateriel`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `CLIENT`
  ...
  ADD CONSTRAINT `CLIENT_ibfk_2` FOREIGN KEY (`idRdv`) REFERENCES `RDV` (`idRdv`) ON DELETE CASCADE ON UPDATE CASCADE;
