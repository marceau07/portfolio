  ...
  var methods = {
    init: function (options) {
      ...
      function ajax(action) {
        ...
        adresse = 'page=specificationWS&'+ serialize + "&action=" + action;
          ...
          toolbar: function () {
            if (settings.editButton || settings.deleteButton) {
              ...
              if (settings.deleteButton) {
                ...
                confirmButton = '<button type="submit" class="tabledit-confirm-button ' + settings.buttons.confirm.class + '" style="display: none; float: none; margin-left: 10px;" name="btSupprimer">' + confirmButtonHtml + '</button>';
              }

              // Create save button.
              if (settings.editButton && settings.saveButton) {
                saveButton = '<button type="submit" class="tabledit-save-button ' + settings.buttons.save.class + '" style="display: none; float: none; margin-left: 10px;" name="btEnvoyer">' + saveButtonHtml + '</button>';
              }

              // Create restore button.
              if (settings.deleteButton && settings.restoreButton) {
                restoreButton = '<button type="submit" class="tabledit-restore-button ' + settings.buttons.restore.class + '" style="display: none; float: none; margin-left: 10px;" name="btRecuperer">' + restoreButtonHtml + '</button>';
              }
