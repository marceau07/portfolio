...
-- Généré le :  Lun 23 Septembre 2019 à 22:34
...
(8, 'marceau0707@gmail.com', '$2y$10$/Q8w.anUcpzeesxa7geYhO9BXgws0.dh5jrA7H312snyYPQRDo7ka', 'RODRIGUES', 'Marceau', '1999-07-07', '62400', 'Bethune', 'Verquin', '0606060606', 2, NULL);
...
(15, '2019-09-26 02:45:00'),
(14, '2019-09-26 15:00:00'),
(4, '2019-09-27 14:15:00'),
(5, '2019-09-27 17:35:00'),
...
--
ALTER TABLE `AVOIR`
  ADD CONSTRAINT `AVOIR_ibfk_1` FOREIGN KEY (`idCli`) REFERENCES `CLIENT` (`idCli`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `AVOIR_ibfk_2` FOREIGN KEY (`idRdv`) REFERENCES `RDV` (`idRdv`) ON DELETE CASCADE ON UPDATE CASCADE;
